...
#define FRAME_WIDTH 640 ///< Width of the frame in pixels - all 640 digital samples per N64 line (the 320 "kept" + the 320 formerly-discarded), same native 640 capture as apps/n64_diag_noskip.
